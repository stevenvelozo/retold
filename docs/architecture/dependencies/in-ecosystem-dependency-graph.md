...
<!-- bespoke diagram: edit diagrams/visual-graph.mmd or .hints.json, then: npx pict-renderer-graph build docs/architecture/dependencies -->
![Visual Graph](diagrams/visual-graph.svg)
