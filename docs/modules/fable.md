...
<!-- bespoke diagram: edit diagrams/the-service-provider-pattern.mmd or .hints.json, then: npx pict-renderer-graph build docs/modules -->
![The Service Provider Pattern](diagrams/the-service-provider-pattern.svg)
