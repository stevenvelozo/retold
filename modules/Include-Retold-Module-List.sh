...
repositoriesOrator=("orator" "orator-serviceserver-restify" "orator-static-server" "orator-http-proxy" "orator-ssl-proxy" "orator-endpoint" "tidings" "orator-conversion" "orator-authentication")
...
repositoriesUtility=("indoctrinate" "manyfest" "cachetrax" "precedent" "quackage" "manyfest-conversion")
